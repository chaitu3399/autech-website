      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-10">
        ...
        <div className="grid lg:grid-cols-12 gap-6 items-stretch">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${isActive ? "bg-[#C8370B]" : "bg-[#F6F6F6]"}`}
                    >
          ...
          <div className="lg:col-span-8 relative noise-bg rounded-sm overflow-hidden min-h-[420px]">
            ...
            <img
              src={INDUSTRIES_IMG}
              alt={t.industries.items[industryActive].t}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7 md:p-10 text-white">
              <div className="label-pill text-white/60 mb-3">
              ...
              <div className="text-white/75 mt-3 max-w-xl text-sm md:text-base leading-relaxed">
                {t.industries.items[industryActive].d}
              </div>
            </div>
          </div>
        </div>
